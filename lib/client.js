...
module.exports = async function connectClient (instance, log, options) {
  ...
  await Page.addScriptToEvaluateOnLoad({ scriptSource: fetch_npm('circular-json/build/circular-json.js') });
  await Page.addScriptToEvaluateOnLoad({ scriptSource: fetch('event-bus.js') });
  await Page.addScriptToEvaluateOnLoad({ scriptSource: fetch('mocha-bridge.js') });
